...
try:
    ...
    __file__ = 'scripts/train_densenet121_multilabel_classification_class=0.py'
...
# cnn = get_densenet(depth=121, input_shape=(256, 256, 3),
#                    n_classes=len(equalized_data_classes[0]),
#                    class_index=0, weights=None)
# cnn.summary()
...
params = {
    ...
    'batch_size': 4,  # !!! CHECK BEFORE LOAD TO FLOYD
...
for train_index, test_index in kf.split(trainval_id_type_list):
    ...
    params['samples_per_epoch'] = 2 * len(train_id_type_list)
